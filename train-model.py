...
#We read the dataset
data = pd.read_csv("ADAUSDT.csv",low_memory=False, names = ["Date","Open",
"High", "Low", "Close", "Vol","quote_asset_volume", "num_trades", 
...
data = data.drop(['Date','quote_asset_volume', 'taker_buy_base_asset_volume', 
                  'Open',"taker_buy_quote_asset_volume"], axis = 1)
...
#Train the model
iter = 1000
history= model.fit(X_train, y_train, epochs = iter, batch_size =70, 
